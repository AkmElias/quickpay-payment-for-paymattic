...
class QuickPaySettings extends BasePaymentMethod
{
    public function __construct()
    {
        parent::__construct(
            ...
            'quickpay',
            [],
            WPPAYFORM_URL .'assets/images/gateways/quickpay.svg'
        );
    }
    ...
    public function globalFields() : array
    {
        return array(
            ...
            'desc' => array(
                'value' => '<p>See our <a href="https://paymattic.com/docs/how-to-integrate-quickpay-in-wordpress-with-paymattic/" target="_blank" rel="noopener">documentation</a> to get more information about quickpay setup.</p>',
                'type' => 'html_attr',
            ),
            'update_available' => array(
                'value' => array(
                    'available' => 'no',
                    'url' => '',
                    'slug' => 'quickpay-payment-for-paymattic'
                ),
                'type' => 'update_check',
                'label' => __('Update to new version avaiable', 'quickpay-payment-for-paymattic'),
            )
        );
    }
    ...
    public function getPaymentSettings() : array
    {
        ...
        return array(
            'settings' => $settings,
            'is_key_defined' => self::isQuickPayKeysDefined()
        );
    }

    public static function getSettings()
    {
        $settings = get_option('wppayform_payment_settings_quickpay', array());
        $settings['update_available'] = static::checkForUpdate('quickpay-payment-for-paymattic');
    ...
    public static function isQuickPayKeysDefined()
    {
        // return defined('WP_PAY_FORM_quickpay_STORE_ID') && defined('WP_PAY_FORM_quickpay_API_TOKEN') && defined("WP_PAY_FORM_quickpay_CHECKOUT_ID");
    }
